...
| `present_at_inspection`       | string | Who was present during the inspection (name(s) or role, e.g. 'the insured', 'the insured and their spouse'). Required.                                                                                                              |
| `present_at_inspection_verb`  | string | Set to 'was' if present_at_inspection names exactly one person, 'were' if it names more than one. Required. Allowed values: was, were.                                                                                              |
...
| `dwelling_stories`            | string | Number of stories. Required. Ex: 1 story, 2 story, 3 story, 4 story.                                                                                                                                                                |
| `year_built`                  | string | Year the dwelling was built. Optional — leave empty if not stated.                                                                                                                                                                  |
...
| `coinsurance_narrative`       | string | Coinsurance narrative — only fill in when the adjuster explicitly states coinsurance figures or that a penalty applies; otherwise leave empty.                                                                                      |
