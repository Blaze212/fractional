...
var FIELD_GUIDANCE = {
  ...
  roof_covering_type:
    'Completes "The shingles on the roof are a ___ that are approximately [age] years old." — a noun phrase naming the shingle product, e.g. "30 year laminate shingles". Use the adjuster\'s own words when the transcript names a product not in the common-values list rather than forcing the closest one. Include the head noun ("shingles") and use digits for the product\'s year rating: transcript "it\'s a thirty year laminate" is "30 year laminate shingles", not "thirty-year laminate" — the missing head noun and the spelled-out number both go into the same rendered sentence as roof_age_years\' digits ("approximately 23 years old"), and "a thirty-year laminate that are approximately 23 years old" is the ungrammatical, mixed-register result of skipping this.',
  roof_condition:
