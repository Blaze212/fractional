...
function buildPrompt(input) {
  ...
  var system = [
    ...
    'Status variants (roof, exterior, personal property, mitigation, mortgage, coinsurance) require an affirmative statement — "the roof was not affected", "there is no mortgage", "no coinsurance penalty applies" — before you choose a value. A direct answer to a direct question is an affirmative statement even when it is one word: where the agent asks "Was mitigation involved?" and the adjuster answers "No", he has answered, and the negative branch is the correct value — set it, and cite his own answer turn as the source_span, never the agent\'s question. Silence is what does not count: a section nobody raised, or a question he talked past without answering, returns the field empty instead.',
