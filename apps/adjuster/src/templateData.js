...
function syncEnumsFileFromRepo_20260902() {
  ...
  "coverage_determination": {
    ...
    "values": [
      ...
      {
        "key": "unknown",
        "label": "Undetermined \\u2014 coverage questionable",
        "text": "and coverage is questionable at this time. {{coverage_supporting_detail}} [NEEDS INPUT: Confirm the coverage determination before filing.]"
      }
    ]
  },
    ...
    "values": [
      {
        "key": "not_affected",
        "label": "Not affected",
        "text": "The dwelling interior was not affected during this loss."
      },
      {
        "key": "affected",
        "label": "Affected",
        "text": "My inspection documented damages within the following areas:\\n\\n{{interior_damage_narrative}}"
      }
    ]
  },
  "interior_damage_narrative": {
    "label": "Interior damage findings, grouped by room",
    "type": "narrative",
    "section": "Interior",
    "required": true,
    "requiredWhen": { "field": "interior_status", "equals": "affected" }
  },
  "other_structures_status": {
    "label": "Other structures status",
    "type": "variant",
    ...
    "values": [
      {
        "key": "none",
        "label": "No damage",
        "text": "Inspection found no storm related damages to any of the insured's other structures."
      },
      {
        "key": "affected",
        "label": "Damaged",
        "text": "My inspection documented damages to the following other structures:\\n\\n{{other_structures_narrative}}"
      }
    ]
  },
  "other_structures_narrative": {
    "label": "Other structures damage findings, grouped by structure",
    "type": "narrative",
    "section": "Other Structures",
    "required": true,
    "requiredWhen": { "field": "other_structures_status", "equals": "affected" }
  },
