...
export const ProductionLog = () => (
  <LogPanel label="production.log">
    <p>You have already built the AI. It works, you shipped it. But you have watched it do strange things in production:</p>
    ...
    <p style={{ marginTop: 16 }}>
      The hard part is making it run reliably without you watching it. <b>That is the gap I fill.</b>
    </p>
  </LogPanel>
);
